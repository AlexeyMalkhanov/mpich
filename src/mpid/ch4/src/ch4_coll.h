...
MPL_STATIC_INLINE_PREFIX int MPID_Barrier(MPIR_Comm * comm, MPIR_Errflag_t * errflag)
{
    ...
    const MPIDI_CH4I_coll_algo_container_t *ch4_algo_parameters_container = NULL;

    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPID_BARRIER);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPID_BARRIER);

    ch4_algo_parameters_container = MPIDI_CH4I_Barrier_select(comm, errflag);

    switch (ch4_algo_parameters_container->id) {
        case MPIDI_CH4I_Barrier_intra_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Barrier_intra_composition_alpha(comm, errflag, ch4_algo_parameters_container);
            break;
        case MPIDI_CH4I_Barrier_intra_composition_beta_id:
            mpi_errno =
                MPIDI_CH4I_Barrier_intra_composition_beta(comm, errflag, ch4_algo_parameters_container);
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_CH4I_Barrier_intra_composition_gamma_id:
            mpi_errno =
                MPIDI_CH4I_Barrier_intra_composition_gamma(comm, errflag, ch4_algo_parameters_container);
            break;
#endif /* MPIDI_BUILD_CH4_SHM */
        case MPIDI_CH4I_Barrier_inter_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Barrier_inter_composition_alpha(comm, errflag, ch4_algo_parameters_container);
            break;
        default:
                                        ...
                                        int root, MPIR_Comm * comm, MPIR_Errflag_t * errflag)
{
    ...
    ch4_algo_parameters_container =
        MPIDI_CH4I_Bcast_select(buffer, count, datatype, root, comm, errflag);

    switch (ch4_algo_parameters_container->id) {
        case MPIDI_CH4I_Bcast_intra_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Bcast_intra_composition_alpha(buffer, count, datatype, root, comm, errflag,
                                                         ch4_algo_parameters_container);
            break;
        case MPIDI_CH4I_Bcast_intra_composition_beta_id:
            mpi_errno =
                MPIDI_CH4I_Bcast_intra_composition_beta(buffer, count, datatype, root, comm, errflag,
                                                        ch4_algo_parameters_container);
            break;
        case MPIDI_CH4I_Bcast_intra_composition_gamma_id:
            mpi_errno =
                MPIDI_CH4I_Bcast_intra_composition_gamma(buffer, count, datatype, root, comm, errflag,
                                                         ch4_algo_parameters_container);
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_CH4I_Bcast_intra_composition_delta_id:
            mpi_errno =
                MPIDI_CH4I_Bcast_intra_composition_delta(buffer, count, datatype, root, comm, errflag,
                                                         ch4_algo_parameters_container);
            break;
#endif /* MPIDI_BUILD_CH4_SHM */
        case MPIDI_CH4I_Bcast_inter_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Bcast_inter_composition_alpha(buffer, count, datatype, root, comm, errflag,
                                                         ch4_algo_parameters_container);
            break;
        default:
                                            ...
                                            MPIR_Errflag_t * errflag)
{
    ...
    ch4_algo_parameters_container =
        MPIDI_CH4I_Allreduce_select(sendbuf, recvbuf, count, datatype, op, comm, errflag);

    switch (ch4_algo_parameters_container->id) {
        case MPIDI_CH4I_Allreduce_intra_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Allreduce_intra_composition_alpha(sendbuf, recvbuf, count, datatype, op, comm,
                                                             errflag, ch4_algo_parameters_container);
            break;
        case MPIDI_CH4I_Allreduce_intra_composition_beta_id:
            mpi_errno =
                MPIDI_CH4I_Allreduce_intra_composition_beta(sendbuf, recvbuf, count, datatype, op, comm,
                                                            errflag, ch4_algo_parameters_container);
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_CH4I_Allreduce_intra_composition_gamma_id:
            mpi_errno =
                MPIDI_CH4I_Allreduce_intra_composition_gamma(sendbuf, recvbuf, count, datatype, op, comm,
                                                             errflag, ch4_algo_parameters_container);
            break;
#endif /* MPIDI_BUILD_CH4_SHM */
        case MPIDI_CH4I_Allreduce_inter_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Allreduce_inter_composition_alpha(sendbuf, recvbuf, count, datatype, op, comm,
                                                             errflag, ch4_algo_parameters_container);
            break;
        default:
                                            ...
                                            MPIR_Errflag_t * errflag)
{
    ...
    ch4_algo_parameters_container =
        MPIDI_CH4I_Allgather_select(sendbuf, sendcount, sendtype, recvbuf,
                                    recvcount, recvtype, comm, errflag);

    switch (ch4_algo_parameters_container->id) {
        case MPIDI_CH4I_Allgather_intra_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Allgather_intra_composition_alpha(sendbuf, sendcount, sendtype,
                                                             recvbuf, recvcount, recvtype,
                                                             comm, errflag,
                                                             ch4_algo_parameters_container);
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_CH4I_Allgather_intra_composition_beta_id:
            mpi_errno =
                MPIDI_CH4I_Allgather_intra_composition_beta(sendbuf, sendcount, sendtype,
                                                            recvbuf, recvcount, recvtype,
                                                            comm, errflag,
                                                            ch4_algo_parameters_container);
            break;
#endif /* MPIDI_BUILD_CH4_SHM */
        case MPIDI_CH4I_Allgather_inter_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Allgather_inter_composition_alpha(sendbuf, sendcount, sendtype,
                                                             recvbuf, recvcount, recvtype,
                                                             comm, errflag,
                                                             ch4_algo_parameters_container);
            break;
                                             ...
                                             MPIR_Errflag_t * errflag)
{
    ...
    ch4_algo_parameters_container =
        MPIDI_CH4I_Allgatherv_select(sendbuf, sendcount, sendtype, recvbuf,
                                     recvcounts, displs, recvtype, comm, errflag);

    switch (ch4_algo_parameters_container->id) {
        case MPIDI_CH4I_Allgatherv_intra_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Allgatherv_intra_composition_alpha(sendbuf, sendcount, sendtype,
                                                              recvbuf, recvcounts, displs,
                                                              recvtype, comm, errflag,
                                                              ch4_algo_parameters_container);
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_CH4I_Allgatherv_intra_composition_beta_id:
            mpi_errno =
                MPIDI_CH4I_Allgatherv_intra_composition_beta(sendbuf, sendcount, sendtype,
                                                             recvbuf, recvcounts, displs,
                                                             recvtype, comm, errflag,
                                                             ch4_algo_parameters_container);
            break;
#endif /* MPIDI_BUILD_CH4_SHM */
        case MPIDI_CH4I_Allgatherv_inter_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Allgatherv_inter_composition_alpha(sendbuf, sendcount, sendtype,
                                                              recvbuf, recvcounts, displs,
                                                              recvtype, comm, errflag,
                                                              ch4_algo_parameters_container);
            break;
                                          ...
                                          MPIR_Errflag_t * errflag)
{
    ...
    ch4_algo_parameters_container =
        MPIDI_CH4I_Scatter_select(sendbuf, sendcount, sendtype, recvbuf,
                                  recvcount, recvtype, root, comm, errflag);


    switch (ch4_algo_parameters_container->id) {
        case MPIDI_CH4I_Scatter_intra_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Scatter_intra_composition_alpha(sendbuf, sendcount, sendtype, recvbuf,
                                                           recvcount, recvtype, root, comm, errflag,
                                                           ch4_algo_parameters_container);
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_CH4I_Scatter_intra_composition_beta_id:
            mpi_errno =
                MPIDI_CH4I_Scatter_intra_composition_beta(sendbuf, sendcount, sendtype, recvbuf,
                                                          recvcount, recvtype, root, comm, errflag,
                                                          ch4_algo_parameters_container);
            break;
#endif /* MPIDI_BUILD_CH4_SHM */
        case MPIDI_CH4I_Scatter_inter_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Scatter_inter_composition_alpha(sendbuf, sendcount, sendtype, recvbuf,
                                                           recvcount, recvtype, root, comm, errflag,
                                                           ch4_algo_parameters_container);
            break;
        default:
                                           ...
                                           int root, MPIR_Comm * comm, MPIR_Errflag_t * errflag)
{
    ...
    ch4_algo_parameters_container =
        MPIDI_CH4I_Scatterv_select(sendbuf, sendcounts, displs, sendtype,
                                   recvbuf, recvcount, recvtype, root, comm, errflag);


    switch (ch4_algo_parameters_container->id) {
        case MPIDI_CH4I_Scatterv_intra_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Scatterv_intra_composition_alpha(sendbuf, sendcounts, displs, sendtype,
...
#ifdef MPIDI_BUILD_CH4_SHM
            mpi_errno =
                MPIDI_CH4I_Scatterv_intra_composition_beta(sendbuf, sendcounts, displs, sendtype,
                                                           recvbuf, recvcount, recvtype, root,
                                                           comm, errflag,
                                                           ch4_algo_parameters_container);
            break;
#endif /* MPIDI_BUILD_CH4_SHM */
        case MPIDI_CH4I_Scatterv_inter_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Scatterv_inter_composition_alpha(sendbuf, sendcounts, displs, sendtype,
                                         ...
                                         int root, MPIR_Comm * comm, MPIR_Errflag_t * errflag)
{
    ...
    ch4_algo_parameters_container =
        MPIDI_CH4I_Gather_select(sendbuf, sendcount, sendtype, recvbuf,
                                 recvcount, recvtype, root, comm, errflag);

    switch (ch4_algo_parameters_container->id) {
        case MPIDI_CH4I_Gather_intra_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Gather_intra_composition_alpha(sendbuf, sendcount, sendtype, recvbuf,
                                                          recvcount, recvtype, root, comm, errflag,
                                                          ch4_algo_parameters_container);
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_CH4I_Gather_intra_composition_beta_id:
            mpi_errno =
                MPIDI_CH4I_Gather_intra_composition_beta(sendbuf, sendcount, sendtype, recvbuf,
                                                         recvcount, recvtype, root, comm, errflag,
                                                         ch4_algo_parameters_container);
            break;
#endif /* MPIDI_BUILD_CH4_SHM */
        case MPIDI_CH4I_Gather_inter_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Gather_inter_composition_alpha(sendbuf, sendcount, sendtype, recvbuf,
                                                          recvcount, recvtype, root, comm, errflag,
                                                          ch4_algo_parameters_container);
            break;
        default:
                                          ...
                                          MPIR_Errflag_t * errflag)
{
    ...
    ch4_algo_parameters_container =
        MPIDI_CH4I_Gatherv_select(sendbuf, sendcount, sendtype, recvbuf,
                                  recvcounts, displs, recvtype, root, comm, errflag);

    switch (ch4_algo_parameters_container->id) {
        case MPIDI_CH4I_Gatherv_intra_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Gatherv_intra_composition_alpha(sendbuf, sendcount, sendtype, recvbuf,
                                                           recvcounts, displs, recvtype, root,
                                                           comm, errflag, ch4_algo_parameters_container);
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_CH4I_Gatherv_intra_composition_beta_id:
            mpi_errno =
                MPIDI_CH4I_Gatherv_intra_composition_beta(sendbuf, sendcount, sendtype, recvbuf,
                                                          recvcounts, displs, recvtype, root,
                                                          comm, errflag, ch4_algo_parameters_container);
            break;
#endif /* MPIDI_BUILD_CH4_SHM */
        case MPIDI_CH4I_Gatherv_inter_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Gatherv_inter_composition_alpha(sendbuf, sendcount, sendtype, recvbuf,
                                                           recvcounts, displs, recvtype, root,
                                                           comm, errflag, ch4_algo_parameters_container);
            break;
        default:
                                           ...
                                           MPIR_Errflag_t * errflag)
{
    ...
    ch4_algo_parameters_container =
        MPIDI_CH4I_Alltoall_select(sendbuf, sendcount, sendtype, recvbuf,
                                   recvcount, recvtype, comm, errflag);

    switch (ch4_algo_parameters_container->id) {
        case MPIDI_CH4I_Alltoall_intra_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Alltoall_intra_composition_alpha(sendbuf, sendcount, sendtype,
                                                            recvbuf, recvcount, recvtype,
                                                            comm, errflag,
                                                            ch4_algo_parameters_container);
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_CH4I_Alltoall_intra_composition_beta_id:
            mpi_errno =
                MPIDI_CH4I_Alltoall_intra_composition_beta(sendbuf, sendcount, sendtype,
                                                           recvbuf, recvcount, recvtype,
                                                           comm, errflag,
                                                           ch4_algo_parameters_container);
            break;
#endif /* MPIDI_BUILD_CH4_SHM */
        case MPIDI_CH4I_Alltoall_inter_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Alltoall_inter_composition_alpha(sendbuf, sendcount, sendtype,
                                                            recvbuf, recvcount, recvtype,
                                                            comm, errflag,
                                                            ch4_algo_parameters_container);
            break;
                                            ...
                                            MPIR_Comm * comm, MPIR_Errflag_t * errflag)
{
    ...
    ch4_algo_parameters_container =
        MPIDI_CH4I_Alltoallv_select(sendbuf, sendcounts, sdispls, sendtype,
                                    recvbuf, recvcounts, rdispls, recvtype, comm, errflag);

    switch (ch4_algo_parameters_container->id) {
        case MPIDI_CH4I_Alltoallv_intra_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Alltoallv_intra_composition_alpha(sendbuf, sendcounts, sdispls,
                                                             sendtype, recvbuf, recvcounts,
                                                             rdispls, recvtype, comm, errflag,
                                                             ch4_algo_parameters_container);
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_CH4I_Alltoallv_intra_composition_beta_id:
            mpi_errno =
                MPIDI_CH4I_Alltoallv_intra_composition_beta(sendbuf, sendcounts, sdispls,
                                                            sendtype, recvbuf, recvcounts,
                                                            rdispls, recvtype, comm, errflag,
                                                            ch4_algo_parameters_container);
            break;
#endif /* MPIDI_BUILD_CH4_SHM */
        case MPIDI_CH4I_Alltoallv_inter_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Alltoallv_inter_composition_alpha(sendbuf, sendcounts, sdispls,
                                                             sendtype, recvbuf, recvcounts,
                                                             rdispls, recvtype, comm, errflag,
                                                             ch4_algo_parameters_container);
            break;
                                            ...
                                            MPIR_Comm * comm, MPIR_Errflag_t * errflag)
{
    ...
    ch4_algo_parameters_container =
        MPIDI_CH4I_Alltoallw_select(sendbuf, sendcounts, sdispls, sendtypes,
                                    recvbuf, recvcounts, rdispls, recvtypes, comm, errflag);

    switch (ch4_algo_parameters_container->id) {
        case MPIDI_CH4I_Alltoallw_intra_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Alltoallw_intra_composition_alpha(sendbuf, sendcounts, sdispls,
                                                             sendtypes, recvbuf, recvcounts,
                                                             rdispls, recvtypes, comm, errflag,
                                                             ch4_algo_parameters_container);
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_CH4I_Alltoallw_intra_composition_beta_id:
            mpi_errno =
                MPIDI_CH4I_Alltoallw_intra_composition_beta(sendbuf, sendcounts, sdispls,
                                                            sendtypes, recvbuf, recvcounts,
                                                            rdispls, recvtypes, comm, errflag,
                                                            ch4_algo_parameters_container);
            break;
#endif /* MPIDI_BUILD_CH4_SHM */
        case MPIDI_CH4I_Alltoallw_inter_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Alltoallw_inter_composition_alpha(sendbuf, sendcounts, sdispls,
                                                             sendtypes, recvbuf, recvcounts,
                                                             rdispls, recvtypes, comm, errflag,
                                                             ch4_algo_parameters_container);
            break;
                                         ...
                                         int root, MPIR_Comm * comm, MPIR_Errflag_t * errflag)
{
    ...
    ch4_algo_parameters_container =
        MPIDI_CH4I_Reduce_select(sendbuf, recvbuf, count, datatype, op, root, comm, errflag);

    switch (ch4_algo_parameters_container->id) {
        case MPIDI_CH4I_Reduce_intra_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Reduce_intra_composition_alpha(sendbuf, recvbuf, count, datatype, op, root,
                                                          comm, errflag, ch4_algo_parameters_container);
            break;
        case MPIDI_CH4I_Reduce_intra_composition_beta_id:
            mpi_errno =
                MPIDI_CH4I_Reduce_intra_composition_beta(sendbuf, recvbuf, count, datatype, op, root,
                                                         comm, errflag, ch4_algo_parameters_container);
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_CH4I_Reduce_intra_composition_gamma_id:
            mpi_errno =
                MPIDI_CH4I_Reduce_intra_composition_gamma(sendbuf, recvbuf, count, datatype, op, root,
                                                          comm, errflag, ch4_algo_parameters_container);
            break;
#endif /* MPIDI_BUILD_CH4_SHM */
        case MPIDI_CH4I_Reduce_inter_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Reduce_inter_composition_alpha(sendbuf, recvbuf, count, datatype, op, root,
                                                          comm, errflag, ch4_algo_parameters_container);
            break;
        default:
                                                 ...
                                                 MPIR_Errflag_t * errflag)
{
    ...
    ch4_algo_parameters_container =
        MPIDI_CH4I_Reduce_scatter_select(sendbuf, recvbuf, recvcounts, datatype,
                                         op, comm, errflag);

    switch (ch4_algo_parameters_container->id) {
        case MPIDI_CH4I_Reduce_scatter_intra_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Reduce_scatter_intra_composition_alpha(sendbuf, recvbuf, recvcounts,
                                                                  datatype, op, comm, errflag,
                                                                  ch4_algo_parameters_container);
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_CH4I_Reduce_scatter_intra_composition_beta_id:
            mpi_errno =
                MPIDI_CH4I_Reduce_scatter_intra_composition_beta(sendbuf, recvbuf, recvcounts,
                                                                 datatype, op, comm, errflag,
                                                                 ch4_algo_parameters_container);
            break;
#endif /* MPIDI_BUILD_CH4_SHM */
        case MPIDI_CH4I_Reduce_scatter_inter_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Reduce_scatter_inter_composition_alpha(sendbuf, recvbuf, recvcounts,
                                                                  datatype, op, comm, errflag,
                                                                  ch4_algo_parameters_container);
            break;
        default:
                                                       ...
                                                       MPIR_Errflag_t * errflag)
{
    ...
    ch4_algo_parameters_container =
        MPIDI_CH4I_Reduce_scatter_block_select(sendbuf, recvbuf, recvcount, datatype,
                                               op, comm, errflag);

    switch (ch4_algo_parameters_container->id) {
        case MPIDI_CH4I_Reduce_scatter_block_intra_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Reduce_scatter_block_intra_composition_alpha(sendbuf, recvbuf, recvcount,
                                                                        datatype, op, comm, errflag,
                                                                        ch4_algo_parameters_container);
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_CH4I_Reduce_scatter_block_intra_composition_beta_id:
            mpi_errno =
                MPIDI_CH4I_Reduce_scatter_block_intra_composition_beta(sendbuf, recvbuf, recvcount,
                                                                       datatype, op, comm, errflag,
                                                                       ch4_algo_parameters_container);
            break;
#endif /* MPIDI_BUILD_CH4_SHM */
        case MPIDI_CH4I_Reduce_scatter_block_inter_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Reduce_scatter_block_inter_composition_alpha(sendbuf, recvbuf, recvcount,
                                                                        datatype, op, comm, errflag,
                                                                        ch4_algo_parameters_container);
            break;
        default:
                                       ...
                                       MPIR_Errflag_t * errflag)
{
    ...
    ch4_algo_parameters_container =
        MPIDI_CH4I_Scan_select(sendbuf, recvbuf, count, datatype, op, comm, errflag);

    switch (ch4_algo_parameters_container->id) {
        case MPIDI_CH4I_Scan_intra_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Scan_intra_composition_alpha(sendbuf, recvbuf, count,
                                                        datatype, op, comm, errflag,
                                                        ch4_algo_parameters_container);
            break;
        case MPIDI_CH4I_Scan_intra_composition_beta_id:
            mpi_errno =
                MPIDI_CH4I_Scan_intra_composition_beta(sendbuf, recvbuf, count,
                                                       datatype, op, comm, errflag,
                                                       ch4_algo_parameters_container);
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_CH4I_Scan_intra_composition_gamma_id:
            mpi_errno =
                MPIDI_CH4I_Scan_intra_composition_gamma(sendbuf, recvbuf, count,
                                                        datatype, op, comm, errflag,
                                                        ch4_algo_parameters_container);
            break;
#endif /* MPIDI_BUILD_CH4_SHM */
                                         ...
                                         MPIR_Errflag_t * errflag)
{
    ...
    ch4_algo_parameters_container =
        MPIDI_CH4I_Exscan_select(sendbuf, recvbuf, count, datatype, op, comm, errflag);

    switch (ch4_algo_parameters_container->id) {
        case MPIDI_CH4I_Exscan_intra_composition_alpha_id:
            mpi_errno =
                MPIDI_CH4I_Exscan_intra_composition_alpha(sendbuf, recvbuf, count,
                                                          datatype, op, comm, errflag,
                                                          ch4_algo_parameters_container);
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_CH4I_Exscan_intra_composition_beta_id:
            mpi_errno =
                MPIDI_CH4I_Exscan_intra_composition_beta(sendbuf, recvbuf, count,
                                                         datatype, op, comm, errflag,
                                                         ch4_algo_parameters_container);
            break;
#endif /* MPIDI_BUILD_CH4_SHM */
